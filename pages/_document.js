    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <script async={true} src="https://www.googletagmanager.com/gtag/js?id=AW-10964336005"></script>
          <script dangerouslySetInnerHTML={{__html: `gtag('config', 'AW-10964336005');`}}></script>
