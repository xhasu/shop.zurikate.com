      ...
      <section className="faqs" ref={faqsEl}>
        <div className="relative py-10 md:pb-32 md:pt-16 text-center mb-16">
          <div className="relative z-10">
            ...
            <h2 className="text-xl text-white text-center mb-4">
              You can search for a 3M certified installers in your area here:
            </h2>
            <Link href="https://get.3mskins.com/home/open/#/companies/publicsearch">
              <a
                target="_blank"
                rel="noreferrer noopener"
                className="text-center px-8 py-2 font-object text-xl text-black bg-primary rounded-lg leading-none inline-block">
                Find 3M installers near you
              </a>
            </Link>
          </div>
        ...
        <div className="section faqs-section max-w-7xl">
          <div className="faqs-body max-w-7xl mx-auto">
            ...
            <p>
              Zurikate corp, is an innovative business that sells full kit skins for the wheels of vehicles. The skins
              or decals are precisely measured and tested to fit on the wheels. These skins are made of 3M vinyl
              stickers, and come in 8 different colors.
            </p>
            <p>
              <strong>
            ...
            <p>
              Great for decorating and changing the color temporarily of your rims. These decals have a strong adhesive
              so that they can effectively stick to the wheels for long periods of time. But at the end of the day, once
              you feel like removing your decal, it can be removed.
            </p>
            <p>
            ...
            <p>
              These kits can protect the wheels from rock chips or side walk scratches and the best part is that it
              looks like paint. Our Product comes with a 2 year warranty.
            </p>
            <p>
              <strong>
          ...
          <div className="faqs-body max-w-7xl mx-auto">
            <h2 className="text-2xl md:text-6xl font-object leading-none mb-8">
              Another way to customize your wheels?{" "}
            </h2>
            <p>
              Currently there are a couple of ways to change or customize the wheels of a vehicle like{" "}
              <span>"Powder coating paint"</span> (Permanent paint) or{" "}
              <span>Buying aftermarket or branded wheels.</span>
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="relative">
                ...
                <p className="max-w-lg pt-8">
                  ...
                  - Painting requires dismounting the wheels and minimum 2 days of work. <br />- Adding to your vehicle
                  aftermarket or branded wheels could affect the performance of the vehicle. <br />
                </p>
              </div>
              <div className="relative">
